  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 relative">
    ...
    <div class="absolute inset-0 pointer-events-none select-none z-0" aria-hidden="true">
      <svg class="absolute top-0 left-0 w-full h-full opacity-[0.08]" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="staff-lines-schedule" x="0" y="0" width="100%" height="150" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#staff-lines-schedule)"/>
      </svg>
    ...
    <!-- Header -->
    <h1 class="section-title mb-8 relative z-10">行程日历</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2">
        ...
        <div v-else>
          <button
            ...
            :key="item.id"
            type="button"
            class="card mb-4 w-full border-l-4 border-mangrove-600 py-4 pl-4 text-left transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-green-500/20 focus:outline-none focus:ring-2 focus:ring-mangrove-400"
      ...
      <div class="lg:col-span-1">
        <div class="card p-5 hover:shadow-xl hover:shadow-green-500/20 transition-all duration-300">
