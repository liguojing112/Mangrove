<template>
  <div class="max-w-3xl mx-auto px-4 sm:px-6 pt-24 pb-16 relative">
    <!-- 背景装饰：五线谱纹理 + 浮动音符 -->
    <div class="absolute inset-0 pointer-events-none select-none z-0" aria-hidden="true">
      <svg class="absolute top-0 left-0 w-full h-full opacity-[0.08]" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="staff-lines-letters" x="0" y="0" width="100%" height="150" patternUnits="userSpaceOnUse">
        ...
        <rect width="100%" height="100%" fill="url(#staff-lines-letters)"/>
      </svg>
    ...
    <!-- Header -->
    <h1 class="section-title mb-4 relative z-10">小芒来信</h1>
    <p class="text-sm text-gray-500 mb-6 relative z-10">来自艺人的语录、来信、日记与独白</p>
